...
function How({ tweaks }) {
  ...
  { icon: "users", title: "Talk, don't just listen", body: "Alexis opens with a short talk to frame the problem. Then it's over to you — guided breakout groups, report-backs, and the chance to share what you found with Alexis and the wider group." },
  ...
  { icon: "calendar-clock", title: "Occasional posts and prompts from Alexis", body: "Alexis may share the odd prompt or question between sessions. Engage as much or as little as you like — there's no pressure to keep up a constant conversation." }];
    ...
    <section className="about" id="alexis">
      <div className="about-inner">
        ...
        <div>
          ...
          <p>Alexis owned and ran a Home Instead homecare franchise for 13 years. She built a team, navigated CQC, worked on staff retention and culture, and eventually sold the business in 2023.</p>
          <p>She is now an executive coach for business owners and senior leaders, drawing on her own experience of running and growing a business — backed by 25 years of coaching practice.</p>
          <div className="about-creds">
            <span className="cred"><i data-lucide="award"></i> 13 years owner / Registered Manager</span>
      ...
      <div className="register-inner">
        <div className="register-copy">
          ...
          <div className="eligibility">
            <div className="eligibility-title"><i data-lucide="user-check"></i> Who can apply</div>
            <p className="eligibility-lede">The Lunch Club is a curated room. To keep conversations relevant and senior, attendees must be <strong>both</strong>:</p>
            <ol className="eligibility-list">
              <li><span className="num">1</span><span>A <strong>senior leader</strong> directly responsible for managing people.</span></li>
              <li><span className="num">2</span><span>Working in <strong>UK domiciliary / homecare</strong>.</span></li>
            </ol>
            <p className="eligibility-note">Once you submit the form, we'll review your application and notify successful applicants <strong>within two working days</strong>.</p>
          </div>
        ...
        <div className="register-card">
          <div className="register-card-head">
            ...
            <div className="register-card-sub">Takes less than a minute. Successful applicants are notified within two working days.</div>
          </div>
